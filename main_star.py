...
from model.mist_star import MMT_VideoQA
from util import compute_a2v
from train.train_mist import train, eval
from data.star_clip_patch_loader import get_videoqa_loaders
...
if not args.test:
    ...
    for epoch in range(args.epochs):
        best_val_acc, best_epoch = train(model, train_loader, a2v, optimizer, criterion, scheduler, epoch, args, val_loader, best_val_acc, best_epoch)
...
eval(model, val_loader, a2v, args, test=True)
