...
class VideoQADataset(Dataset):
    def __init__(
        ...
        :param topk_selector_dataloading: whether select topk-frames which match with the question most
        """
        # self.csv_path = csv_path
        self.data = pd.read_csv(f'../mist/mist_data/datasets/mad/hard_{split}.csv')
        self.dset = 'nextqa'
        ...
        if not topk_selector_dataloading:
            app_feat_file = osp.join(self.video_feature_path, f'frame_feat/CLIP_B32_frames_features_5fps_{num_frames_in_feature_file}_frames_per_video.h5')
        elif topk_selector_dataloading:
            app_feat_file = osp.join(self.video_feature_path, f'frame_feat/CLIP_B32_frames_features_5fps.h5')
