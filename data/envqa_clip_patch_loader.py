...
class VideoQADataset(Dataset):
    def __init__(
        ...
        """
        self.data = json.load(open(f'/home/thong/ay2324_projects/vidl_projects/mist_project/mist/mist_data/datasets/envqa/{split}_full_question_with_choices.json'))
        self.dset = 'envqa'
    ...
    def __getitem__(self, index):
        ...
        vid_id = '_'.join(cur_sample["video_id"].split('_')[:3])
