...
class AModel(nn.Module):
    ...
    def forward(self, answer):
        if len(answer.shape) == 3:
            ...
            answer, text_attention = self.bert(answer)
        ...
        return answer_g, answer, text_attention
...
class MIST_VideoQA(nn.Module):
    ...
    def get_answer_embedding(self, answer):
        answer_g, answer, text_attention = self.amodel(answer)
        return answer_g, answer, text_attention
    ...
    def forward(
        ...
        answer_g, answer_w, text_attention = (
        ...
        for ista in self.ISTA:
            attended_vq, seg_feat, video_video_attention = ista(q_feat, text_mask, question, seg_feat, video_proj)
