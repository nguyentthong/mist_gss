...
def main():
    frame_num = 32
    dataset = VideoCLIPDataset(None, frame_num, "/home/thong/ay2324_projects/vidl_projects/youtube_data/videos_1/*.mp4")
    print(len(dataset))
    ...
    dataset_feats = h5py.File("/home/thong/ay2324_projects/vidl_projects/mist/mist_data/feats/ytdata_1/frame_feat/clip_patch_feat_all.h5", 'w')
