...
from model.mist_nextqa import MIST_VideoQA
from util import compute_a2v, save_to
from train.train_nextqa import train, eval
from data.nextqa_clip_patch_loader import get_videoqa_loaders
...
def main(args):
    ...
    if not args.test:
        ...
        for epoch in range(args.epochs):
            ...
            val_acc, results = eval(model, test_loader, a2v, args, test=False)
